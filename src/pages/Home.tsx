...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col max-w-screen">
      <img src="/bg_home_wirandi.svg" className="absolute -z-10 object-cover left-0 w-full" />
      <Navbar />
      <div className="py-32 max-w-[900px] w-full px-5 lg:px-20">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center space-y-8 lg:space-y-0 lg:space-x-20 py-24 lg:py-32 px-5 lg:px-20">
        ...
        <div className="flex flex-col items-start text-start">
          ...
          <p className="text-lg font-normal leading-[150%]">
            ...
            telah berdiri sejak 27 Agustus 1997 dan telah memiliki Izin Usaha Niaga Umum (INU) dari
            BPH Migas.
            <br />
            <br />
